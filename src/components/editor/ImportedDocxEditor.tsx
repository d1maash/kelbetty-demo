...
import { Download, FileText, Loader2, AlertCircle, RefreshCw, Save } from 'lucide-react'
import { toast } from 'sonner'

interface ImportedDocxEditorProps {
    document: {
        id: string
        title: string
        html: string
...
export default function ImportedDocxEditor({ document, onSave }: ImportedDocxEditorProps) {
    ...
    useEffect(() => {
        if (document.html && editorRef.current) {
            // Загружаем HTML контент в редактор
        ...
        <div className="h-full flex flex-col bg-white">
            ...
            <div className="border-t border-slate-200 p-3 bg-slate-50">
                <div className="flex items-center justify-between text-xs text-slate-500">
                    <p>
                        💡 Документ полностью редактируемый. Все стили и форматирование сохранены.
                    </p>
                    <p>
