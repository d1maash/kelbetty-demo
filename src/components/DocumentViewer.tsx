...
export default function DocumentViewer({
    ...
    const createIframeContent = (html: string, fonts: string[], assets: string[]) => {
        return `
<!DOCTYPE html>
<html lang="ru">
<head>
    ...
    <style>
        * {
        ...
        /* Сохраняем все inline стили */
        *[style] {
            /* Inline стили имеют приоритет */
        }
...
<body>
    ...
    useEffect(() => {
        ...
        try {
            ...
            const content = createIframeContent(html, fonts, assets)
    ...
    }, [html, fonts, assets, title, onError, onLoad])
        ...
        <div className={`document-viewer ${className}`}>
                    ...
                    <div className="absolute inset-0 bg-white bg-opacity-90 flex items-center justify-center z-10">
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 max-w-md mx-4">
                            ...
                            <p className="text-blue-700 text-sm">
                                Обрабатываем документ для точного отображения
                            </p>
                        </div>
                    </div>
                )}
            ...
            <div className="border-t border-gray-200 p-3 bg-gray-50">
                <div className="flex items-center justify-between text-xs text-gray-500">
                    ...
                    <p>
                        Шрифты: {fonts.length} • Ресурсы: {assets.length}
                    </p>
                </div>
            </div>
        </div>
